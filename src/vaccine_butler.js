  ...
  tpl = {
    ...
    get: {
      ...
      appointmentCount() {
        ...
        let count = 0;
        for(let index = 0; index < tpl.results.length; index++) {
          let result = tpl.results[index];
      ...
      matchingCount() {
        ...
        for(let index = 0; index < tpl.results.length; index++) {
          let result = tpl.results[index];
          count += result.appointments.filter(appointment => appointment.isMatch).length;
        }
